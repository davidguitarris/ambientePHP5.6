...
sudo apt-get install php5.6 php5.6-common --assume-yes --force-yes
sudo apt-get install php5.6-cli libapache2-mod-php5.6 php5.6-mysql php5.6-curl php-memcached php5.6-dev php5.6-mcrypt php5.6-sqlite3 php5.6-mbstring zip unzip --assume-yes --force-yes
